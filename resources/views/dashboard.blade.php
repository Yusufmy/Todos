    ...
    @csrf
        <div class="d-flex align-items-start justify-content-between">
            <div class="d-flex flex-column">
                ...
                <br>
                <span>
                    <a style="text-decoration: none" href="/create" class="text-success">Create</a>  <a style="text-decoration: none" href="#">Complated</a>
                </span>
            </div>
        ...
        <div id="comments" class="mt-4">
            ...
            <div class="comment d-flex align-items-start mt-3">
                ...
                <div class="ml-md-4 ml-0">
                    <form action="{{ route('complated.io', $item->id) }}">
